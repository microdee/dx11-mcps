...
{
    #region PluginInfo
    [PluginInfo(Name = "Register", AutoEvaluate = true, Category = "DX11.Mcps.Core", Version = "ParticleSystem", Help = "Registers a particle system and outputs the variables of shaders that are registered to this particle system. It also calculates the stride. ", Author = "tmp", Tags = "")]
